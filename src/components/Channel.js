...
import { LSK_NO_CHANNEL_SELECTED_MESSAGE } from '../locale';
...
class Channel extends PureComponent {
  ...
  render() {
    ...
    if (!channel.cid) {
      return <Text>{localizedStrings[LSK_NO_CHANNEL_SELECTED_MESSAGE]}</Text>;
    }
...
const ChannelWithContext = withChatContext(withLocalizationContext(Channel));
