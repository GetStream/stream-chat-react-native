...
import { LSK_CHANNEL_PREVIEW_MESSENGER_NO_MESSAGE } from '../locale';
        ...
        <Details>
          ...
          >
            {!this.props.latestMessage
              ? localizedStrings[LSK_CHANNEL_PREVIEW_MESSENGER_NO_MESSAGE]
...
const ChannelPreviewMessengerWithContext = withLocalizationContext(
