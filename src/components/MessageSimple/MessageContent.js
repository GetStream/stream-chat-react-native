...
import {
  LSK_MESSAGE_ACTIONSHEET_REACTION_OPTION,
  LSK_MESSAGE_ACTIONSHEET_EDIT_OPTION,
  LSK_MESSAGE_ACTIONSHEET_DELETE_OPTION,
  LSK_MESSAGE_DELETED_TEXT,
} from '../../locale';
  ...
  render() {
    ...
    if (
      ...
      options.splice(1, 0, {
        ...
        title: localizedStrings[LSK_MESSAGE_ACTIONSHEET_REACTION_OPTION],
      });
    }
    ...
    if (
      ...
      options.splice(1, 0, {
        ...
        title: localizedStrings[LSK_MESSAGE_ACTIONSHEET_EDIT_OPTION],
      });
    ...
    if (
      ...
      options.splice(1, 0, {
        ...
        title: localizedStrings[LSK_MESSAGE_ACTIONSHEET_DELETE_OPTION],
      });
    ...
    if (message.deleted_at)
      return (
        <DeletedContainer alignment={pos}>
          <DeletedText>
            {localizedStrings[LSK_MESSAGE_DELETED_TEXT]}
          </DeletedText>
        </DeletedContainer>
      );
...
const MessageContentWithContext = withLocalizationContext(
