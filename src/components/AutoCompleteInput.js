...
import { LSK_AUTO_COMPLETE_INPUT_PLACEHOLDER } from '../locale';
...
export const AutoCompleteInput = withLocalizationContext(
    ...
    render() {
      ...
      return (
        <InputBox
          ...
          placeholder={localizedStrings[LSK_AUTO_COMPLETE_INPUT_PLACEHOLDER]}
          onChangeText={(text) => {
