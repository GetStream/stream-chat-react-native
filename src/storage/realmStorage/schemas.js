...
export const ChannelSchema = {
  ...
  properties: {
    ...
    last_message_at: { type: 'date', optional: true, indexed: true },
    created_at: { type: 'string', optional: true, indexed: true },
    updated_at: { type: 'string', optional: true, indexed: true },
    initialized: 'bool',
