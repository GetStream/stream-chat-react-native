...
// start - added for react-native-reanimated v2
...
// end - added for react-native-reanimated v2
...
{
  RCTEnableTurboModule(YES); // added for react-native-reanimated v2
#ifdef FB_SONARKIT_ENABLED
  ...
  RCTRootView *rootView = [[RCTRootView alloc] initWithBridge:bridge
                                                   moduleName:@"TypeScriptMessaging"
