...
Yet when used in a message level, or anywhere deeper in the element tree (i.e. in a custom component) it might cause unnecessary re-renders of the message list.
