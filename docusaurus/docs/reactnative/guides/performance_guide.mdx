...
The [ChannelContext](../../state-and-offline-support/contexts/channel-context) is a React Context that provides a set of useful methods and data to its children.
