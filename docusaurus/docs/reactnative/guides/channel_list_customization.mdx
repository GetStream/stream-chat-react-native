...
| `message.new`                                                                             | Moves the channel to top of the list                               | [lockChannelOrder](../core-components/channel_list.mdx#lockchannelorder), [OnNewMessageEvent](../core-components/channel_list.mdx#onnewmessageevent) |
...
| `notification.message_new`                                                                | Adds the new channel to the top of the list and starts watching it | [OnNewMessageNotification](../core-components/channel_list.mdx#onnewmessagenotification)                                                             |
...
In this case you can replace the default functionality by providing a custom [`OnNewMessageNotification`](../core-components/channel_list.mdx#onnewmessagenotification) function as prop to `ChannelList` component.
