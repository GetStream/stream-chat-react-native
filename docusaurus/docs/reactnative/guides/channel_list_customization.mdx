...
| `message.new`                                                                             | Moves the channel to top of the list                               | [lockChannelOrder](../core-components/channel_list.mdx#lockchannelorder), [onNewMessage](../core-components/channel_list.mdx#onnewmessage) |
