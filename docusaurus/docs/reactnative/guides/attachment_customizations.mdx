...
Attachments is a property on a `message` object:
...
- attachment type `image` - [Gallery](../../ui-components/gallery) (single or multiple images)
- attachment type `giphy` - [Giphy](../../ui-components/giphy)
- attachment type `file` - [FileAttachment](../../ui-components/file-attachment)
- attachment with url  - [Card](../../ui-components/card)
