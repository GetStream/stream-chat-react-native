...
"stream-chat-react-native": "link:../stream-chat-react-native/native-package", // If youre using the native package
"stream-chat-expo": "link:../stream-chat-react-native/expo-package", // If youre using expo
```
