...
## Stream Chat Push and Expo

Stream push notifications aren't supported on Expo. If you are using Expo and want push notifications, you can achieve this using [Webhooks](https://getstream.io/chat/docs/react-native/webhooks_overview/?language=javascript) and a third party push provider. See the following article for an [example](https://support.getstream.io/hc/en-us/articles/1500006478421-How-can-I-use-the-Stream-Webhook-to-send-customers-emails-based-on-Chat-events-).
