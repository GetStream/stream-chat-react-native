...
When a device receives this payload, you can generate a local notification on device. For this purpose you can use [Notifee](https://notifee.app/), which is a A feature rich notifications library for React Native.
