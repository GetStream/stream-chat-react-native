...
First and foremost, make sure to follow all steps from [Migrating to v5](../migration-guides/migrating-from-4.x-to-5.x) guide. To enable offline support, please follow the given steps:
