...
`ChatContext` is provided by [`Chat`](../../../ui-components/chat) component. If you are not familiar with React Context API, please read about it on [React docs](https://reactjs.org/docs/context.html).
...
### <div class="label description">_forwarded from [Chat](../../../ui-components/chat#imagecomponent)_ props</div> ImageComponent {#imagecomponent}
