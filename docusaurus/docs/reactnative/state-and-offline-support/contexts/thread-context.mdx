...
`ThreadContext` is provided by [`Channel`](../../../ui-components/channel) component. If you are not familiar with React Context API, please read about it on [React docs](https://reactjs.org/docs/context.html).
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#allowthreadmessagesinchannel)_ props</div> allowThreadMessagesInChannel {#allowthreadmessagesinchannel}
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#thread)_ props</div> thread {#thread}
