...
import MoreOptionsButton from '../../common-content/ui-components/channel/props/more_options_button.mdx';
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#showthreadmessageinchannelbutton)_ props</div> ShowThreadMessageInChannelButton {#showthreadmessageinchannelbutton}
