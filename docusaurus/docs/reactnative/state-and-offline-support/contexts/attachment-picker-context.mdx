...
`AttachmentPickerContext` is provided by [`OverlayProvider`](../../../ui-components/overlay-provider) component. If you are not familiar with React Context API, please read about it on [React docs](https://reactjs.org/docs/context.html).
...
### <div class="label description">_forwarded from [OverlayProvider](../../../ui-components/overlay-provider#attachmentpickerbottomsheetheight)_ props</div> attachmentPickerBottomSheetHeight {#attachmentpickerbottomsheetheight}

<AttachmentPickerBottomSheetHeight />

### <div class="label description">_forwarded from [OverlayProvider](../../../ui-components/overlay-provider#attachmentselectionbarheight)_ props</div> attachmentSelectionBarHeight {#attachmentselectionbarheight}
...
| Type   | Default                                                              |
| ------ | -------------------------------------------------------------------- |
| number | [`bottomInset`](../../../ui-components/overlay-provider#bottominset) |

### <div class="label description">_forwarded from [OverlayProvider](../../../ui-components/overlay-provider#cameraselectoricon)_ props</div> CameraSelectorIcon {#cameraselectoricon}
...
### <div class="label description">_forwarded from [OverlayProvider](../../../ui-components/overlay-provider#fileselectoricon)_ props</div> FileSelectorIcon {#fileselectoricon}

<FileSelectorIcon />

### <div class="label description">_forwarded from [OverlayProvider](../../../ui-components/overlay-provider#imageselectoricon)_ props</div> ImageSelectorIcon {#imageselectoricon}
...
| Type   | Default                                                        |
| ------ | -------------------------------------------------------------- |
| number | [`topInset`](../../../ui-components/overlay-provider#topInset) |
