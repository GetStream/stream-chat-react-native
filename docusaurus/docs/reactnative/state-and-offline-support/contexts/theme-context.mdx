...
`ThemeContext` is provided by [`OverlayProvider`](../../../ui-components/overlay-provider) and [`Chat`](../../../ui-components/chat) components.
...
merged with the theme you pass as `style` to [`OverlayProvider`](../../../ui-components/overlay-provider) or [`Chat`](../../../ui-components/chat) components.
