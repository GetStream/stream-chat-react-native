...
Group styles returned by this function can be accessed by `groupStyles` value from [`MessageContext`](../../../../state-and-offline-support/contexts/message-context.mdx)
