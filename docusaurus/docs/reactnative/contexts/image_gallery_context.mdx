...
| Type |
| - |
| [MessageType](https://github.com/GetStream/stream-chat-react-native/blob/master/src/components/MessageList/hooks/useMessageList.ts)[] |

### setImage

Setter for value [`image`](#image)
...
| Type |
| - |
| (messageWithImages: [MessageType](https://github.com/GetStream/stream-chat-react-native/blob/master/src/components/MessageList/hooks/useMessageList.ts)[]) => void |
