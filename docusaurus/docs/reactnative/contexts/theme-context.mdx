...
`ThemeContext` is provided by [`OverlayProvider`](../core-components/overlay-provider.mdx) and [`Chat`](../../core-components/chat) components.
Read the [theming section](../customization/theme.mdx) for more information on how to customize your theme.
...
merged with the theme you pass as `style` to [`OverlayProvider`](../core-components/overlay-provider.mdx) or [`Chat`](../../core-components/chat) components.
