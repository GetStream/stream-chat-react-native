...
### <div class="label description">_forwarded from [MessageInputContext](../contexts/message_input_context.mdx#additionaltextinputprops)_ props</div> additionalTextInputProps {#additionaltextinputprops}
