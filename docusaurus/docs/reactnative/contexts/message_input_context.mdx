...
import MaxFileSizeToUploadInMB from '../common-content/core-components/channel/props/max_file_size_to_upload_in_mb.mdx';
...
### <div class="label description">_forwarded from [Channel](../core-components/channel.mdx#maxfilesizetouploadinmb)_ props</div> maxFileSizeToUploadInMB {#maxfilesizetouploadinmb}
