...
import EmojiSearchIndex from '../common-content/core-components/channel/props/emoji_search_index.mdx';
...
### <div class="label description">_forwarded from [Channel](../core-components/channel.mdx#emojisearchindex)_ props</div> `emojiSearchIndex` {#emojiSearchIndex}
