...
import nativeAttachmentPickerStep1 from '../assets/ui-cookbook/custom-message-input/native_attachment_picker_step_1.png';
import nativeAttachmentPickerStep2 from '../assets/ui-cookbook/custom-message-input/native_attachment_picker_step_2.png';
...
- [`doImageUploadRequest`](../../ui-components/channel#doimageuploadrequest): For images picked from image picker
- [`doDocUploadRequest`](../../ui-components/channel#dodocuploadrequest): For files picked from file picker
...
Channel component receives a prop [AttachButton](../../ui-components/channel#attachbutton),
...
with upload previews ([`ImageUploadPreview`](../ui-components/message-input/image-upload-preview.mdx)) within `MessageInput` component
by using a function `uploadNewImage` provided by [`MessageInputContext`](../../state-and-offline-support/contexts/message-input-context#uploadnewimage).

For file attachments, the SDK defaults to the native file picker. That can be reused by adding the `pickFile` function
provided by the [`MessageInputContext`](../../state-and-offline-support/contexts/message-input-context#pickfile) as an action handler within the action sheet.
...
To make a custom editing state header, you can use the [Channel](../../ui-components/channel) component with a custom Editing state header component and pass it inside [InputEditingStateHeader](../../ui-components/channel#inputeditingstateheader) prop.
...
To make a custom reply state header, you can use the [Channel](../../ui-components/channel) component with a custom Reply state header component and pass it inside [InputReplyStateHeader](../../ui-components/channel#inputreplystateheader) prop.
...
To make a custom Giphy search input, you can use the [Channel](../../ui-components/channel) component with a custom Giphy Search component and pass it inside [InputGiphySearch](../../ui-components/channel#inputgiphysearch) prop.
...
- [`doImageUploadRequest`](../../ui-components/channel#doimageuploadrequest): For images
- [`doDocUploadRequest`](../../ui-components/channel#dodocuploadrequest): For any files other than images
