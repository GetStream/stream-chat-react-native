...
Default value for this prop is [`ChannelListMessenger`](../ui-components/channel-list/channel-list-messenger.mdx) and it consumes [`ChannelsContext`](../contexts/channels_context.mdx), which provides all the necessary values to implement infinite scroll pagination.
