---
id: custom-channel-list
sidebar_position: 4
title: Custom ChannelList
---

import loadMoreButton from '../assets/ui-cookbook/custom-channel-list/load_more_button.png';

Let's look at how to make some customizations to [`ChannelList`](../ui-components/channel-list-components/channel-list.mdx).
...
It's important to note that [`filters`](../ui-components/channel-list-components/channel-list.mdx#filters) don't apply to updates to the list from events.
...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `channel.deleted`                                                                         | Remove channel from the list                                       | [onChannelDeleted](../ui-components/channel-list-components/channel-list.mdx#onchanneldeleted)                                                                                         |
| `channel.hidden`                                                                          | Remove channel from the list                                       | [onChannelHidden](../ui-components/channel-list-components/channel-list.mdx#onchannelhidden)                                                                                           |
| `channel.truncated`                                                                       | Updates the channel                                                | [onChannelTruncated](../ui-components/channel-list-components/channel-list.mdx#onchanneltruncated)                                                                                     |
| `channel.updated`                                                                         | Updates the channel                                                | [onChannelUpdated](../ui-components/channel-list-components/channel-list.mdx#onchannelupdated)                                                                                         |
| `channel.visible`                                                                         | Adds the channel to the list                                       | [onChannelVisible](../ui-components/channel-list-components/channel-list.mdx#onchannelvisible)                                                                                         |
| `message.new`                                                                             | Moves the channel to top of the list                               | [lockChannelOrder](../ui-components/channel-list-components/channel-list.mdx#lockchannelorder), [onNewMessage](../ui-components/channel-list-components/channel-list.mdx#onnewmessage) |
| `notification.added_to_channel`                                                           | Adds the new channel to the top of the list and starts watching it | [onAddedToChannel](../ui-components/channel-list-components/channel-list.mdx#onaddedtochannel)                                                                                         |
| `notification.message_new`                                                                | Adds the new channel to the top of the list and starts watching it | [onNewMessageNotification](../ui-components/channel-list-components/channel-list.mdx#onnewmessagenotification)                                                                         |
| `notification.removed_from_channel`                                                       | Removes the channel from the list                                  | [onRemovedFromChannel](../ui-components/channel-list-components/channel-list.mdx#onremovedfromchannel)                                                                                 |
...
The default behavior when this event occurs is to query the channel the message is received on, then add the channel to the top of the list, irrespective of [`filters`](../ui-components/channel-list-components/channel-list.mdx#filters).
...
In this case you can replace the default functionality by providing a custom [`onNewMessageNotification`](../ui-components/channel-list-components/channel-list.mdx#onnewmessagenotification) function as prop to `ChannelList` component.
...
`ChannelList` component accepts the [`List`](../ui-components/channel-list-components/channel-list.mdx#list) prop, which is a component to render the list of channels.
Default value for this prop is [`ChannelListMessenger`](../ui-components/channel-list-components/channel-list-messenger.mdx) and it consumes [`ChannelsContext`](../../ui-components/contexts/channels-context), which provides all the necessary values to implement infinite scroll pagination.
This component internally uses FlatList from react-native. And [`loadNextPage`](../../ui-components/contexts/channels-context#loadnextpage) function
...
Its possible to override the props on underlying FlatList by providing [`additionalFlatListProps`](../ui-components/channel-list-components/channel-list.mdx#additionalflatlistprops) prop to `ChannelList` or `ChannelListMessenger`.
...
"Load More" button should invoke [`loadNextPage`](../../ui-components/contexts/channels-context#loadnextpage) function, when pressed.
