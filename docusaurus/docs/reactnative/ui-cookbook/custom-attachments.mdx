...
- attachment type `image` - [Gallery](../ui-components/message-components/gallery.mdx) (single or multiple images)
- attachment type `giphy` - [Giphy](../ui-components/message-components/giphy.mdx)
- attachment type `file` - [FileAttachment](../ui-components/message-components/file-attachment.mdx)
- attachment with URL - [Card](../ui-components/message-components/card.mdx)
