...
- attachment type `image` - [Gallery](../../ui-components/message/gallery) (single or multiple images)
- attachment type `giphy` - [Giphy](../../ui-components/message/giphy)
- attachment type `file` - [FileAttachment](../../ui-components/message/file-attachment)
- attachment with URL - [Card](../../ui-components/message/card)
