...
:::note
All the configuration for `MessageInput` can be done on [`Channel`](../core-components/channel.mdx) component. Additionally please take a look at [Guide Section](../guides/message_input_customization.mdx) about customizing MessageInput UI
:::
