...
### <div class="label description">_overrides the value from [MessageInputContext](../contexts/message_input_context.mdx#maxfilesizetouploadinmb)_</div> maxFileSizeToUploadInMB {#maxfilesizetouploadinmb}
