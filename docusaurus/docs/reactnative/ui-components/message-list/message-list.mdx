...
Determines whether the list is active. The value is derived from the `isChannelActive` in the [`ChannelContext`](../../../state-and-offline-support/contexts/channel-context).
