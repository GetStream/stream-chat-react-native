...
Component to render the avatar of a channel, within the [`ChannelList`](../../channel-list) component.

## General Usage

You can customize this component and provide it back to the SDK via the [`PreviewAvatar`](../../channel-list#previewavatar) prop on `ChannelList` if desired.
