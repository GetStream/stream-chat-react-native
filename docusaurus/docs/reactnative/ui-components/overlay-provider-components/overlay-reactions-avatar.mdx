...
This is the default component provided to the prop [`OverlayReactionsAvatar`](./overlay-provider.mdx#overlayreactionsavatar) on the `OverlayProvider` component.
