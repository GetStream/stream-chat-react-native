...
This is the default component provided to the prop [`OverlayReactions`](./overlay-provider.mdx#overlayreactions) on the `OverlayProvider` component.
...
### <div class="label description">overrides the value from [MessagesContext](../../../ui-components/contexts/messages-context#supportedreactions)</div> `supportedReactions` {#supportedreactions}
