...
This is the default component provided to the prop [`OverlayReactions`](../../overlay-provider#overlayreactions) on the `OverlayProvider` component.
...
### <div class="label description">overrides the value from [MessagesContext](../../../state-and-offline-support/contexts/messages-context#supportedreactions)</div> `supportedReactions` {#supportedreactions}
