...
### <div class="label description">overrides the value from [MessagesContext](../../contexts/messages_context.mdx#supportedreactions)</div> `supportedReactions` {#supportedreactions}
