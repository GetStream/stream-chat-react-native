...
Partially overrides the `value` provided to the `OverlayContext`. This prop can be used to set the [theme](https://getstream.io/chat/docs/sdk/reactnative/customization/theming/) via the `style` key.
