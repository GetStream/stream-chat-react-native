...
### <div class="label description">_overrides the value from [MessageOverlayContext](../../contexts/message_overlay_context.mdx#data)_</div> `data` {#data}
...
### <div class="label description">_overrides the value from [MessagesContext](../../contexts/messages_context.mdx#supportedreactions)_</div> `supportedReactions` {#supportedreactions}
