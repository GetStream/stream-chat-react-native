...
This is the default component provided to the prop [`SendMessageDisallowedIndicator`](../channel/channel.mdx#sendmessagedisallowedindicator) on the `Channel` component.
