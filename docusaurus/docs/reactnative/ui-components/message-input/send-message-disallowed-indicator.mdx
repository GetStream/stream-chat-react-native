...
This is the default component provided to the prop [`SendMessageDisallowedIndicator`](../../../../ui-components/channel#sendmessagedisallowedindicator) on the `Channel` component.
