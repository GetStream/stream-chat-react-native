...
`MessageInputContext` is provided by [`Channel`](../../../ui-components/channel) component. If you are not familiar with React Context API, please read about it on [React docs](https://reactjs.org/docs/context.html).
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#additionaltextinputprops)_ props</div> additionalTextInputProps {#additionaltextinputprops}

<AdditionalTextInputProps />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#autocompletesuggestionslimit)_ props</div> autoCompleteSuggestionsLimit {#autocompletesuggestionslimit}

<AutoCompleteSuggestionsLimit />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#autocompletetriggersettings)_ props</div> autoCompleteTriggerSettings {#autocompletetriggersettings}
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#compressimagequality)_ props</div> compressImageQuality {#compressimagequality}
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#dodocuploadrequest)_ props</div> doDocUploadRequest {#dodocuploadrequest}

<DoDocUploadRequest />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#doimageuploadrequest)_ props</div> doImageUploadRequest {#doimageuploadrequest}
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#editmessage)_ props</div> `editMessage` {#editmessage}

<EditMessage />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#emojisearchindex)_ props</div> `emojiSearchIndex` {#emojiSearchIndex}

<EmojiSearchIndex />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#hascommands)_ props</div> `hasCommands` {#hascommands}

<HasCommands />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#hasfilepicker)_ props</div> hasFilePicker {#hasfilepicker}

<HasFilePicker />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#hasimagepicker)_ props</div> hasImagePicker {#hasimagepicker}

<HasImagePicker />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#initialvalue)_ props</div> `initialValue` {#initialvalue}

<InitialValue />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#maxmessagelength)_ props</div> maxMessageLength {#maxmessagelength}

<MaxMessageLength />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#maxnumberoffiles)_ props</div> maxNumberOfFiles {#maxnumberoffiles}

<MaxNumberOfFiles />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#mentionallappusersenabled)_ props</div> mentionAllAppUsersEnabled {#mentionallappusersenabled}

<MentionAllAppUsersEnabled />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#mentionallappusersquery)_ props</div> mentionAllAppUsersQuery {#mentionallappusersquery}

<MentionAllAppUsersQuery />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#numberoflines)_ props</div> numberOfLines {#numberoflines}

<NumberOfLines />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#onchangetext)_ props</div> onChangeText {#onchangetext}
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#sendimageasync)_ props</div> sendImageAsync {#sendimageasync}
...
### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#attachbutton)_ props</div> AttachButton {#attachbutton}

<AttachButton />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#commandsbutton)_ props</div> CommandsButton {#commandsbutton}

<CommandsButton />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#fileuploadpreview)_ props</div> FileUploadPreview {#fileuploadpreview}

<FileUploadPreview />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#imageuploadpreview)_ props</div> ImageUploadPreview {#imageuploadpreview}

<ImageUploadPreview />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#input)_ props</div> Input {#input}

<Input />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#inputbuttons)_ props</div> InputButtons {#inputbuttons}

<InputButtons />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#moreoptionsbutton)_ props</div> MoreOptionsButton {#moreoptionsbutton}

<MoreOptionsButton />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#sendbutton)_ props</div> SendButton {#sendbutton}

<SendButton />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#sendmessagedisallowedindicator)_ props</div> SendMessageDisallowedIndicator {#sendmessagedisallowedindicator}

<SendMessageDisallowedIndicator />

### <div class="label description">_forwarded from [Channel](../../ui-components/channel/channel.mdx#showthreadmessageinchannelbutton)_ props</div> ShowThreadMessageInChannelButton {#showthreadmessageinchannelbutton}

<ShowThreadMessageInChannelButton />

### <div class="label description">_forwarded from [Channel](../../../ui-components/channel#uploadprogressindicator)_ props</div> UploadProgressIndicator {#uploadprogressindicator}
