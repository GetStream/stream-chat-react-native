...
`TranslationContext` is provided by [`OverlayProvider`](../../ui-components/overlay-provider-components/overlay-provider.mdx) and [`Chat`](../../../ui-components/chat) components.
Read the [Adding Internationalization (i18n) section](../../../advanced-guides/internationalization) for more information on how to customize your translations.
