...
`TypingContext` is provided by [`Channel`](../../../ui-components/channel) component. If you are not familiar with React Context API, please read about it on [React docs](https://reactjs.org/docs/context.html).
