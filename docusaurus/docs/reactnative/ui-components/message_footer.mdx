...
A component to render footer of message, which consists of read receipts, timestamp of message etc. This component uses [`MessageStatus`](./message_status.mdx) for rendering read recipts internally.
