...
import DeletedMessagesVisibilityType from '../common-content/contexts/messages-context/deleted_messages_visibility_type.mdx'
...
### <div class="label description">_overrides the value from [MessageContext](../contexts/messages_context.mdx#deletedmessagesvisibiltytype)_</div> deletedMessagesVisibiltyType {#deletedmessagesvisibiltytype}
