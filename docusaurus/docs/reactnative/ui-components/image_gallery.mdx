...
### <div class="label description">_forwarded from [OverlayProvider](../core-components/overlay_provider.mdx#imagegallerycustomcomponents) props_</div> `imageGalleryCustomComponents` {#imagegallerycustomcomponents}
