---
id: reply-state-header
title: ReplyStateHeader
---
...
This is the default component provided to the prop [`ReplyStateHeader`](../core-components/channel.mdx#replystateheader) on the `Channel` component.
