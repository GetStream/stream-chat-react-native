...
Component to render footer of message, which consists of read receipts, timestamp of message etc. This component uses [`MessageStatus`](../message-status) for rendering read receipts internally.
...
### <div class="label description">_overrides the value from [MessagesContext](../../../state-and-offline-support/contexts/messages-context#deletedmessagesvisibiltytype)_</div> `deletedMessagesVisibilityType` {#deletedmessagesvisibilitytype}
