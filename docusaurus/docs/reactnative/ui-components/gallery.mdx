...
import ImagesAndVideos from '../common-content/contexts/message-context/images_and_videos.mdx';
...
### <div class="label description">_overrides the value from [MessageContext](../contexts/message_context.mdx#imagesandvideos)_</div> imagesAndVideos {#imagesAndVideos}
