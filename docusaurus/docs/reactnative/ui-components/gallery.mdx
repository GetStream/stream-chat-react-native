...
A component to render image attachments within the [`MessageList`](./message_list.mdx).
...
When true, onPress handler will be disabled.
...
### <div class="label description">_overrides the value from [ImageOverlayContext](../contexts/image_overlay_context.mdx#setimage)_</div> setImage {#setimage}
