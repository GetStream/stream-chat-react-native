...
Check the [Customize Message Input guide]([Customize Message Input](../guides/message_input_customization.mdx)) for more details about how to customize this component
