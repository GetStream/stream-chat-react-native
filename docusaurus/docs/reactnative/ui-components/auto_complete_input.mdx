...
Whether there is currently a cooldown active in a channel with [slow mode](https://getstream.io/chat/docs/javascript/slow_mode/?language=javascript#channel-slow-mode) enabled.
