...
UI component to render UI for deleted messages. [`MessageContent`](./message_content.mdx) component uses `MessageDeleted` component to render messages which have `deleted_at` property as non-empty.
