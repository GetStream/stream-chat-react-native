...
### <div class="label description">_overrides the value from [MessagesContext](../../../ui-components/contexts/messages-context#deletedmessagesvisibiltytype)_</div> `deletedMessagesVisibilityType` {#deletedmessagesvisibilitytype}
