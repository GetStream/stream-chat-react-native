...
Component to render `system` type messages within the [`MessageList`](../message-list-components/message-list.mdx).

This is the default component provided to the prop [`MessageSystem`](../../../ui-components/channel#messagesystem) on the `Channel` component.
