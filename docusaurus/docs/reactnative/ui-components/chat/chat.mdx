...
`Chat` provides the [ChatContext](../../state-and-offline-support/contexts/chat-context), [TranslationContext](../../../state-and-offline-support/contexts/translation-context), and [ThemeContext](../../../state-and-offline-support/contexts/theme-context) to its child components.
