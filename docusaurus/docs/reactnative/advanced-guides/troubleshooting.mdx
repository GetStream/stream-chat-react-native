...
Please refer to the [Stream Chat with Navigation](../navigation) documentation to properly place the `OverlayProvider` in relation to your navigation solution or other components.
...
Please refer to the [Stream Chat with Navigation](../navigation) documentation to properly place the `OverlayProvider` in relation to your navigation solution.
