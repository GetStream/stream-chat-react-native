...
import chatOverviewPage from '../../assets/advanced-guides/push-notifications/v2/chat_overview_page.png';
import firebaseNotificationsToggle from '../../assets/advanced-guides/push-notifications/v2/firebase_notifications_toggle.png';
