...
- [`disableKeyboardCompatibleView`](../../ui-components/channel#disablekeyboardcompatibleview) - `boolean`
- [`keyboardBehavior`](../../ui-components/channel#keyboardbehaviour) - 'padding' | 'position' | 'height'
- [`keyboardVerticalOffset`](../../ui-components/channel#keyboardverticaloffset) - `number`
