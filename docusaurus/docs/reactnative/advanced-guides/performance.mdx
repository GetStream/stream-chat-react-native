...
import channelSettings from '../assets/advanced-guides/performance/channel_settings.jpeg';
...
The [Channel](../../ui-components/channel) component updates its internal react state based on chat related events received from the WebSocket.
...
The [ChannelContext](../../ui-components/contexts/channel-context) is a React Context that provides a set of useful methods and data to its children.
