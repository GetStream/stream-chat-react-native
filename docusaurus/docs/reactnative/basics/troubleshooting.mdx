...
If your Android app is using targetSdkVersion of 33 or above. We expect that you are using React Native version 0.71 to ask for the media permissions instead of storage permissions. Please ensure that your app has this combination.
