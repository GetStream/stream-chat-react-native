...
### Instructions for version >=2.0.0
...
Also, if your React Native version is (>=0.68) you will need a version of >=2.0.0 for `react-native-gesture-handler` for your app to build.

## Custom Touchables not working
