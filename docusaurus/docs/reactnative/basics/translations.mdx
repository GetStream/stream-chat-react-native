...
If you deploy your app to users who speak another language, you might want to internationalize it.
...
No parameters are required, this will default to English (en). If you choose to use the default English settings with Day.js you do
...
### Switch/set language for components

As mentioned earlier, we provide built in translations for some languages such as French, Spanish etc out-of-the-box.
...
You can switch the default language for UI components as following:
...
Existing language can be overriden with the same process as [Adding a new language](#adding-a-new-language). As an example, we'll override the translations for Dutch language.
...
Alternatively you can also provide your own [`Moment`](https://momentjs.com/) object
...
Similarly you can also provide your own [Dayjs](https://day.js.org/docs/en/installation/installation) object
