...
Meanwhile, you can use our [React SDK](https://getstream.io/chat/docs/sdk/react/) for Web. They almost follow the same API and Component convention as the React Native SDK, so you should be able to use them efficiently.
