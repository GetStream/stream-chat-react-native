...
- [`expo-media-library`](https://docs.expo.dev/versions/v48.0.0/sdk/media-library/)
- [`@react-native-community/netinfo`](https://github.com/react-native-netinfo/react-native-netinfo)
- [`@stream-io/flat-list-mvcp`](https://github.com/GetStream/flat-list-mvcp)
- [`expo-file-system`](https://docs.expo.dev/versions/v48.0.0/sdk/filesystem/)
- [`react-native-gesture-handler`](https://github.com/software-mansion/react-native-gesture-handler)
- [`expo-image-picker`](https://docs.expo.dev/versions/v48.0.0/sdk/imagepicker/)
- [`expo-image-manipulator`](https://docs.expo.dev/versions/v48.0.0/sdk/imagemanipulator/)
- [`react-native-reanimated`](https://github.com/software-mansion/react-native-reanimated)
- [`react-native-svg`](https://docs.expo.dev/versions/v48.0.0/sdk/svg/)
...
Install [`react-native-video`](https://github.com/react-native-video/react-native-video) for RN CLI or [`expo-av`](https://docs.expo.dev/versions/v48.0.0/sdk/av/) for Expo CLI in your React Native project.
...
Install [`react-native-share`](https://github.com/react-native-share/react-native-share) for RN CLI or [`expo-sharing`](https://docs.expo.dev/versions/v48.0.0/sdk/sharing/) in your React Native project.
...
Install [`react-native-haptic-feedback`](https://github.com/junina-de/react-native-haptic-feedback) for RN CLI or [`expo-haptics`](https://docs.expo.dev/versions/v48.0.0/sdk/haptics/) for Expo CLI in your React Native project.
...
Install [`@react-native-clipboard/clipboard`](https://github.com/react-native-clipboard/clipboard) for RN CLI or [`expo-clipboard`](https://docs.expo.dev/versions/v48.0.0/sdk/clipboard/) for Expo ClI to be able to copy messages to the clipboard.
...
Install [`react-native-document-picker`](https://github.com/rnmods/react-native-document-picker) for RN CLI or [`expo-document-picker`](https://docs.expo.dev/versions/v48.0.0/sdk/document-picker/) for Expo CLI to access the file picker and upload the file.
