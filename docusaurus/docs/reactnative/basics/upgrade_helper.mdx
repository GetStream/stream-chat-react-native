...
import scrollViewWarning from '../assets/basics/upgrade-helper/scroll_view_warning.png';
import slowMode from '../assets/basics/upgrade-helper/slow_mode.gif';
...
For details please read the docs on 
...
```tsx
<OverlayProvider maxTextNumberOfLines={300}>
  {/** child components */}
</OverlayProvider>
```
