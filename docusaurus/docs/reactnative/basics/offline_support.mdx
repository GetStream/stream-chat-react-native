...
> Offline support is currently not implemented for Expo package (stream-chat-expo). However, you can get things working via
the [expo-dev-client](https://docs.expo.dev/development/getting-started/) library and adding [config plugins](https://docs.expo.dev/guides/config-plugins/)
