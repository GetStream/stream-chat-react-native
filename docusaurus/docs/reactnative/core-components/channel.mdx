...
This component takes StreamChat `channel` as prop. You can either [create a channel](https://getstream.io/chat/docs/javascript/creating_channels/?language=javascript) before rendering Channel component. Or if you are navigating from [`ChannelList`](./channel_list.mdx) component, channel is available as parameter on [`onSelect`](./channel_list.mdx#required-onselect) prop function.
...
| Type | Default |
|- -|- -|
| Component, element | [KeyboardCompatibleView](https://github.com/GetStream/stream-chat-react-native/blob/master/package/src/components/KeyboardCompatibleView/KeyboardCompatibleView.tsx) |
...
| Type | Default |
|- -|- -|
| Component, element | [UploadProgressIndicator](https://github.com/GetStream/stream-chat-react-native/blob/master/package/src/components/MessageInput/UploadProgressIndicator.tsx) |
