...
`Channel` is a higher order component. It doesn't provide any UI itself, but mainly acts as a bridge between its child components such as [MessageList](../../ui-components/message-list), [MessageInput](../../ui-components/message-input) and [Thread](../../ui-components/thread) components. Channel provides multiple contexts to the enclosed components and allows for modification of many of the enclosed components via props that are then kept in context.
...
This component takes StreamChat `channel` as prop. You can either [create a channel](https://getstream.io/chat/docs/javascript/creating_channels/?language=javascript) before rendering Channel component. Or if you are navigating from [`ChannelList`](../channel-list) component, channel is available as parameter on [`onSelect`](../channel-list#required-onselect) prop function.
...
- [ChannelContext](../../contexts/channel-context)
- [MessageInputContext](../../contexts/message-input-context)
- [MessagesContext](../../contexts/messages-context)
- [PaginatedMessageListContext](../../contexts/paginated-message-list-context)
- [ThreadContext](../../contexts/thread-context)
- [TypingContext](../../contexts/typing-context)
