...
import PinMessage from '../common-content/core-components/channel/props/pin_message.mdx';
import PinMessageEnabled from '../common-content/core-components/channel/props/pin_message_enabled.mdx';
...
Throttling interval (in milliseconds) for react state update for channel. By default state updates are throttled at 500ms, but for high concurrency
