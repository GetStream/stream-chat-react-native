...
import OnNewMessageEvent from '../common-content/core-components/channel-list/props/on_new_message_event.mdx';
import OnNewMessageNotification from '../common-content/core-components/channel-list/props/on_new_message_notification.mdx';
