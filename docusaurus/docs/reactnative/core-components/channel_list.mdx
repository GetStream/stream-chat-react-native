...
ChannelList component is a provider of [ChannelsContext](../../contexts/channels-context). All the child components of ChannelList can access this context using a hook `useChannelsContext`.
