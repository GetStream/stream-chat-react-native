...
**Expo:** [`expo-clipboard`](https://docs.expo.dev/versions/v48.0.0/sdk/clipboard/)
...
**React Native:** [`@react-native-camera-roll/camera-roll`](https://github.com/react-native-cameraroll/react-native-cameraroll)
