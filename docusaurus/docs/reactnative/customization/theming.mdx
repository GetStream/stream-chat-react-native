...
You can find the default theme object in [theme.ts](https://github.com/GetStream/stream-chat-react-native/blob/master/src/contexts/themeContext/utils/theme.ts).
...
Both of these components take a prop `style` which accepts a custom theme.
...
The exported types and original theme in [theme.ts](https://github.com/GetStream/stream-chat-react-native/blob/master/src/contexts/themeContext/utils/theme.ts) can then be referenced to create a custom modification to the theme.
...
The TypeScript documentation of [`Theme`]((https://github.com/GetStream/stream-chat-react-native/blob/master/src/contexts/themeContext/utils/theme.ts)) should help you in this regard.
