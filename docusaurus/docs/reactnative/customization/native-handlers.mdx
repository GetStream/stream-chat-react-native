...
| React Native CLI                                                                                           | Expo                                                                            |
| ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [`@react-native-community/cameraroll`](https://github.com/react-native-cameraroll/react-native-cameraroll) | [`expo-media-library`](https://docs.expo.io/versions/latest/sdk/media-library/) |
...
| React Native CLI                                                                                                                                    | Expo                                                                |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| [`react-native-fs`](https://github.com/itinance/react-native-fs) & [`react-native-share`](https://github.com/react-native-share/react-native-share) | [`expo-sharing`](https://docs.expo.io/versions/latest/sdk/sharing/) |
