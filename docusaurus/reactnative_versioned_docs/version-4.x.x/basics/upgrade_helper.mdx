...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
  <img src={slowMode} alt='Un-themed' width='280' style={{ objectFit: 'contain', paddingBottom: '8px' }} />
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
  <img src={pinMessageAction} alt='Un-themed' width='280' style={{ objectFit: 'contain', paddingBottom: '8px' }} />
...
A separate guide has been added to documentation for details of [How To Customize Message Actions UI](../guides/message_actions_customization.mdx#how-to-customize-message-action-ui)
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
  <img src={scrollViewWarning} alt='Un-themed' width='100%' style={{ objectFit: 'contain', paddingBottom: '8px' }} />
</div>
