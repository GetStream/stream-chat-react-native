...
import channelSettings from '../assets/guides/performance/channel_settings.jpeg';
...
The [Channel](../../core-components/channel) component updates its internal react state based on chat related events received from the WebSocket.
...
The [ChannelContext](../../contexts/channel-context) is a React Context that provides a set of useful methods and data to its children.
