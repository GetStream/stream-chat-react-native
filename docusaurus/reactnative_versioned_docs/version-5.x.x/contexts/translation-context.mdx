...
`TranslationContext` is provided by [`OverlayProvider`](../core-components/overlay-provider.mdx) and [`Chat`](../../core-components/chat) components.
Read the [Adding Internationalization (i18n) section](../basics/internationalization.mdx) for more information on how to customize your translations.
