...
>(
  ...
  const handleAppBackground = useCallback(() => {
    type ChannelDataType = Extract<typeof channel.data, { own_capabilities?: string[] }>;
    const channelDefaultCapabilties = (channel?.data as ChannelDataType)?.own_capabilities;
