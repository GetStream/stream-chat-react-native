...
export type ChatProps<StreamChatClient extends ExtendableGenerics = DefaultStreamChatGenerics> =
...
const ChatWithContext = <StreamChatClient extends ExtendableGenerics = DefaultStreamChatGenerics>(
 ...
 */
export const Chat = <StreamChatClient extends ExtendableGenerics = DefaultStreamChatGenerics>(
  props: PropsWithChildren<ChatProps<StreamChatClient>>,
) => {
