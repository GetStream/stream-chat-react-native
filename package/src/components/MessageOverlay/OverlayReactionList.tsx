...
>(
  ...
  const { data } = useMessageOverlayContext<StreamChatGenerics>('OverlayReactionList');
  const { supportedReactions } = useMessagesContext<StreamChatGenerics>('OverlayReactionList');
