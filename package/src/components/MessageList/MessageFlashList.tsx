...
> &
  ...
  > & {
     ...
     * ```
     */
    additionalFlatListProps?: Partial<FlashListProps<LocalMessage>>;
    /**
...
const MessageListFlashListWithContext = (props: MessageListFlashListPropsWithContext) => {
  ...
  const { dateSeparatorsRef, messageGroupStylesRef, processedMessageList } = useMessageFlashList({
    noGroupByUser,
    threadList,
  });
      ...
      {processedMessageList.length === 0 && !thread ? (
        ...
        <FlashList
          ...
          maintainVisibleContentPosition={{
            autoscrollToBottomThreshold: threadList ? 10 : undefined,
