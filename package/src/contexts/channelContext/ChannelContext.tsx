...
> = {
   ...
   *
   * **Default** [EmptyStateIndicator](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Indicators/EmptyStateIndicator.tsx)
   */
   ...
   *
   * **Default** [DateHeader](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageList/DateHeader.tsx)
   */
