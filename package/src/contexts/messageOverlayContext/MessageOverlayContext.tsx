...
> = {
   ...
   *
   * **Default** [MessageActions](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageOverlay/MessageActions.tsx)
   */
   ...
   *
   * **Default** [OverlayReactionList](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageOverlay/OverlayReactionList.tsx)
   */
  OverlayReactionList: React.ComponentType<OverlayReactionListProps<At, Ch, Co, Ev, Me, Re, Us>>;
  /**
   ...
   *
   * **Default** [OverlayReactions](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageOverlay/OverlayReactions.tsx)
   */
