...
export type ChannelState<StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> = {
...
type ChannelsState<StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> = { [cid: string]: ChannelState<At, Ch, Co, Ev, Me, Re, Us> };

export type Keys = keyof ChannelState;

export type Payload<Key extends Keys = Keys, StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> = {
  cid: string;
  key: Key;
  value: ChannelState<At, Ch, Co, Ev, Me, Re, Us>[Key];
};

type SetStateAction<StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> = { payload: Payload<Keys, At, Ch, Co, Ev, Me, Re, Us>; type: 'SET_STATE' };
...
type Action<StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> =
  | SetStateAction<At, Ch, Co, Ev, Me, Re, Us>
  | IncreaseSubscriberCountAction
  | DecreaseSubscriberCountAction;

export type ChannelsStateContextValue<StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> = {
...
type Reducer<StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics> = (
  state: ChannelsState<At, Ch, Co, Ev, Me, Re, Us>,
...
export const ChannelsStateProvider = <StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics>({
  children,
}: {
  children: ReactNode;
}) => {
...
export const useChannelsStateContext = <StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics>() =>
...
export const withChannelsStateContext = <P extends UnknownType, StreamChatClient extends StreamChatGenerics = DefaultStreamChatGenerics>(
