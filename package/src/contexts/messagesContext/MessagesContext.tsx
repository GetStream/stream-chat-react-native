...
> = MessagesConfig & {
   ...
   * Defaults to: [Attachment](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/Attachment.tsx)
   */
   ...
   * Defaults to: [AttachmentActions](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/AttachmentActions.tsx)
   */
   ...
   * Defaults to: [Card](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/Card.tsx)
   */
  Card: React.ComponentType<CardProps<At, Ch, Co, Ev, Me, Re, Us>>;
  /**
   * UI component for DateHeader
   * Defaults to: [DateHeader](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageList/DateHeader.tsx)
   **/
   ...
   * Defaults to: [FileAttachment](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/FileAttachment.tsx)
   */
   ...
   * Defaults to: [FileAttachmentGroup](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/FileAttachmentGroup.tsx)
   */
   ...
   * Defaults to: https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/FileIcon.tsx
   */
  FileAttachmentIcon: React.ComponentType<FileIconProps>;
  FlatList: typeof FlatList;
  /**
   * UI component to display image attachments
   * Defaults to: [Gallery](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/Gallery.tsx)
   */
  Gallery: React.ComponentType<GalleryProps<At, Ch, Co, Ev, Me, Re, Us>>;
  /**
   * UI component for Giphy
   * Defaults to: [Giphy](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/Giphy.tsx)
   */
   ...
   * Defaults to: [InlineDateSeparator](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageList/InlineDateSeparator.tsx)
   */
  InlineDateSeparator: React.ComponentType<InlineDateSeparatorProps>;
  /**
   * UI component for InlineUnreadIndicator
   * Defaults to: [InlineUnreadIndicator](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Message/MessageSimple/InlineUnreadIndicator.tsx)
   **/
   ...
   * Defaults to: [MessageAvatar](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Message/MessageSimple/MessageAvatar.tsx)
   **/
  MessageAvatar: React.ComponentType<MessageAvatarProps<At, Ch, Co, Ev, Me, Re, Us>>;
  /**
   * UI component for MessageContent
   * Defaults to: [MessageContent](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Message/MessageSimple/MessageContent.tsx)
   */
   ...
   * Defaults to: [MessageDeleted](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageSimple/MessageDeleted.tsx)
   */
   ...
   * Defaults to: [MessageReplies](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageSimple/MessageReplies.tsx)
   */
  MessageReplies: React.ComponentType<MessageRepliesProps<At, Ch, Co, Ev, Me, Re, Us>>;
  /**
   * UI Component for MessageRepliesAvatars
   * Defaults to: [MessageRepliesAvatars](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/MessageSimple/MessageRepliesAvatars.tsx)
   */
   ...
   * Defaults to: [MessageSimple](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Message/MessageSimple/MessageSimple.tsx)
   */
  MessageSimple: React.ComponentType<MessageSimpleProps<At, Ch, Co, Ev, Me, Re, Us>>;
  /**
   * UI component for MessageStatus (delivered/read)
   * Defaults to: [MessageStatus](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Message/MessageSimple/MessageStatus.tsx)
   */
   ...
   * Defaults to: [ReactionList](https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Reaction/ReactionList.tsx)
   */
   ...
   * Defaults to https://github.com/GetStream/stream-chat-react-native/blob/main/src/components/Attachment/Card.tsx
   */
