...
import { FixedSizeQueueCache, LocalMessage, MessageComposer } from 'stream-chat';
...
export const useMessageComposer = ({ editing: editedMessage }: UseMessageComposerParams) => {
