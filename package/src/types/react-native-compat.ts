 ...
 *
 * Those `*Instance` types do not exist on React Native < 0.87 and this SDK supports `>=0.79`, so we
 ...
 * in this SDK's public message list surface, and neither spelling exists across the whole `>=0.79`
